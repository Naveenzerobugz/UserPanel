...
function selct_district2($val) {
    ...
    if ($val == 'Maharashtra') {
        var maharashtra = ["SELECT", "Ahmednagar", "Akola", "Alibag", "Amaravati", "Arnala", "Aurangabad", "Aurangabad", "Bandra", "Bassain", "Belapur", "Bhiwandi", "Bhusaval", "Borliai-Mandla", "Chandrapur", "Dahanu", "Daulatabad", "Dighi (Pune)", "Dombivali", "Goa", "Jaitapur", "Jalgaon",
    ...
    if ($val == 'Uttar Pradesh') {
        var up = ["SELECT", "Agra", "Allahabad", "Auraiya", "Banbasa", "Bareilly", "Berhni", "Bhadohi", "Dadri", "Dharchula", "Gandhar", "Gauriphanta", "Ghaziabad", "Gorakhpur", "Gunji",
                                      ...
                                      "Pantnagar", "Saharanpur", "Sonauli", "Surajpur", "Varanasi"];
        $(function () {
            var options = '';
    ...
    if ($val == 'Uttarakhand') {
        var uttarakhand = ["SELECT", "Almora", "Badrinath", "Bangla", "Barkot", "Bazpur", "Chamoli", "Chopra", "Dehra Dun", "Dwarahat", "Garhwal", "Haldwani", "Hardwar", "Haridwar", "Jamal", "Jwalapur", "Kalsi", "Kashipur", "Mall",
                                             "Mussoorie", "Nahar", "Naini", "Pantnagar", "Pauri", "Pithoragarh", "Rameshwar", "Rishikesh", "Rohni", "Roorkee", "Sama", "Saur", "Tikonia"];
        $(function () {
            var options = '';
