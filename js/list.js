...
function CreateList() {
    ...
    if ($("[id*=txttitle]").val() == '' || $("[id*=dllcategory]").val() == '' || $("[id*=txtaddress]").val() == '' || $("[id*=dllcity]").val() == '' || $("[id*=txtCountry]").val() == '' || $("[id*=txtstate]").val() == '' || $("[id*=txtzipcode]").val() == '' || $("[id*=txtmob]").val() == '' || $("[id*=txtemail]").val() == '' || $("[id*=txtdescription]").val() == '' || $("[id*=minprice]").val() == '' || $("[id*=maxprice]").val() == '') {
    ...
    loginFrm.append("country", $("#txtCountry option:selected").text());
    loginFrm.append("state", $("#txtState option:selected").text());
    loginFrm.append("city", $("#txtCity option:selected").text());
    ...
    alert($('#amenities1').val());

    alert($("#amenities1").attr("checked") ? 1 : 0);
    loginFrm.append("amenities1", $("#amenities1").attr("checked") ? 1 : 0);
    loginFrm.append("amenities2", $('#amenities2').attr("checked") ? 1 : 0);
    loginFrm.append("amenities3", $('#amenities3').attr("checked") ? 1 : 0);
    loginFrm.append("amenities4", $('#amenities4').attr("checked") ? 1 : 0);
    loginFrm.append("amenities5", $('#amenities5').attr("checked") ? 1 : 0);
    loginFrm.append("amenities6", $('#amenities6').attr("checked") ? 1 : 0);
    loginFrm.append("amenities7", $('#amenities7').attr("checked") ? 1 : 0);


    loginFrm.append("mondayopen", $("#ddlmondayopen option:selected").text());
    loginFrm.append("mondayclose", $("#ddlmondayclose option:selected").text());
    loginFrm.append("tuesdayopen", $("#ddltuesdayopen option:selected").text());
    loginFrm.append("tuesdayclose", $("#ddltuesdayclose option:selected").text());
    loginFrm.append("wednesdayopen", $("#ddlwednesdayopen option:selected").text());
    loginFrm.append("wednesdayclose", $("#ddlwednesdayclose option:selected").text());
    loginFrm.append("thursdayopen", $("#ddlthursdayopen option:selected").text());
    loginFrm.append("thursdayclose", $("#ddlthursdayclose option:selected").text());
    loginFrm.append("Fridayopen", $("#ddlFridayopen option:selected").text());
    loginFrm.append("Fridayclose", $("#ddlFridayclose option:selected").text());
    loginFrm.append("saturdayopen", $("#ddlsaturdayopen option:selected").text());
    loginFrm.append("saturdayclose", $("#ddlsaturdayclose option:selected").text());
    loginFrm.append("sundayopen", $("#ddlsundayopen option:selected").text());
    loginFrm.append("sundayclose", $("#ddlsundayclose option:selected").text());
...
function Updatelist() {
    ...
    loginFrm.append("category", $("[id*=dllcategory]").val());
    loginFrm.append("address", $("[id*=txtaddress]").val());
    loginFrm.append("country", $("[id*=txtCountry]").val());
